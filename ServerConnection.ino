...
IPAddress server(192,168,7,133);  // mi servidor en internet
//char server[] = "http://mxmtsvrandon1";    // name address for Google (using DNS)
...
void setup() {
  ...
  if (client.connect(server, 80)== 1) {
    ...
    // Make a HTTP request:
    client.println("GET /arduino/arduino.php?number=2 HTTP/1.1");
    client.println("Host: mxmtsvrandon1");
